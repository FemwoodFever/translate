...
translate rus strings:
    ...
    new "Загрузка сотрет текущий прогресс.\nВы уверены, что хотите это сделать?"
    old "Are you sure you want to quit?"
    new "Вы уверены, что хотите покинуть игру?"
    old "Are you sure you want to return to the main menu?\nThis will lose unsaved progress."
    new "Вы уверены, что хотите вернуться в главное меню?\nЭто действие сотрет несохраненный прогресс."
    ...
    new "Вы уверены, что хотите пропустить новые диалоги и перейти к следующему выбору?"
